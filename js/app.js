    ...
    function windowLoaded() {
        let documentActions = e => {
            ...
            if (isTouchScreen) {
                ...
                } else document.querySelector(".lang-header").classList.remove("--active");
                if (targetElement.closest(".items-catalog-header__more")) {
                    const targetItem = targetElement.closest(".items-catalog-header__item");
                    const targeActivetItem = document.querySelector(".items-catalog-header__item.--active");
                    targetItem.classList.toggle("--active");
                    if (targetItem !== targeActivetItem) targeActivetItem.classList.remove("--active");
                }
            }
        };
